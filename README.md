...
```bash
git clone --branch "v2.11.0" https://github.com/advanced-security/policy-as-code.git && cd ./policy-as-code
...
```Powershell
git clone --branch "v2.11.0" https://github.com/advanced-security/policy-as-code.git
cd policy-as-code
